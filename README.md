...
website-template/
├── config/
│   └── system_prompt.txt   # AI System Prompt (Easy to edit)
├── public/
...
**Legacy Method:**
You can still set `OPENROUTER_SYSTEM_PROMPT` in your `.env` file, but it overrides the file-based prompt and can be tricky with newlines in some deployment environments.
